  ...
  return (
    ...
    <footer className="bg-[#1C2028] text-white pt-10 pb-4 shadow-lg w-full">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8"> 
        ...
        <Link 
  href="http://www.youtube.com/@cfflnigeria" 
  aria-label="YouTube" 
...
>
  <svg 
    ...
    viewBox="0 0 24 24"
  >
    <path d="M23.5 6.2a2.96 2.96 0 0 0-2.08-2.1C19.6 3.5 12 3.5 12 3.5s-7.6 0-9.42.6A2.96 2.96 0 0 0 .5 6.2 31.2 31.2 0 0 0 0 12a31.2 31.2 0 0 0 .5 5.8 2.96 2.96 0 0 0 2.08 2.1C4.4 20.5 12 20.5 12 20.5s7.6 0 9.42-.6a2.96 2.96 0 0 0 2.08-2.1A31.2 31.2 0 0 0 24 12a31.2 31.2 0 0 0-.5-5.8zM9.6 15.5V8.5L15.8 12l-6.2 3.5z"/>
  </svg>
</Link>
