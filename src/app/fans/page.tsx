...
export default async function MeetTheFansPage() {
  ...
  return (
    <div className="min-h-screen text-white">
      {/* ✅ HERO SECTION (Dark Background with Navbar) */}
      <section className="relative w-full min-h-[400px] flex flex-col items-center justify-center overflow-hidden bg-[#13141C]">
        {/* Navbar inside hero */}
      ...
      {/* 🖼 FAN GALLERY (White Background) */}
      <main className="bg-white text-black py-16 px-6 md:px-12">
              ...
              {fans.map((fan) => (
                ...
                >
                  {fan.image ? (
                    ...
                    <div className="flex items-center justify-center h-[300px] bg-gray-200 text-gray-500 text-sm">
                      No image
                    </div>
                  )}
                </div>
